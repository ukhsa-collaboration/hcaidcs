...
#'   \item{patient_location}{A string giving location of patient at time of specimen}
#'   \item{patient_category}{A string giving admission status of patient at time of specimen}
#'}
"line_listing"
