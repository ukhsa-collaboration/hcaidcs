...
#' * \code{age_group_new} A variable giving the age group generated by \code{\link{mandatory_age_group}}.
#' * \code{rate} The rate per 100,000 population
#' * \code{sex} Sex variable, to allow side-by-side bars
#' * \code{fyear6} Financial year
