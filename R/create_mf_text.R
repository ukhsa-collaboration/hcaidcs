#' Creates objects for referencing in text of factsheet
#'
#' The function will calculate the percentage change of the most recent month compared to the value 12 months ago,
#' or the percentage change of the summed most recent three months compared to the summed three months, 12 months ago
#' or the percentage change of the summed most recent 12 months compared to summed 12 months, 12 months ago.
#'
#' @param data A data frame
#' @param collection A string giving the data collection, one of "mrsa", "mssa", "ecoli", "kleb", "paer", "cdi"
#' @param output_reqd A string giving the desired output, one of "12_month", "3_month", "12_avg"
#'
