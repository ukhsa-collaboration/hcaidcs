...
This is likely to happen if you are installing it in a work environment, where local IT have set up a proxy server to connect to the internet. 
You may be able to get around this by telling R to use your proxy settings.

To determine your proxy settings go to 'Internet options' and select the 'Connections' tab. 
Choose the 'LAN settings' button and make a note of the address and port number. 
![proxy settings](./docs/proxy1.png)
...
## Use
Please see [the online documentation](https://publichealthengland.github.io/hcaidcs/) for descriptions of functions. 
Vignettes on the use of the package will follow soon. 
